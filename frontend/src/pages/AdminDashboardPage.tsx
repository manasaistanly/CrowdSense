                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {capacities.map((dest) => {
                            ...
                            return (
                                <div key={dest.id} className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                                    ...
                                    <div className="flex items-end gap-2 mb-2">
                                        <span className="text-3xl font-bold text-gray-900">{dest.currentCapacity}</span>
                                        <span className="text-sm text-gray-500 mb-1">/ {dest.maxDailyCapacity} entered</span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-gray-500">{dest.maxDailyCapacity - dest.currentCapacity} slots remaining</span>
                                        <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xl font-bold text-gray-900">{stats?.totalVisitorsToday}</p>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                            <h2 className="text-lg font-bold text-gray-900">Recent Entry Requests</h2>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {recentBookings.map((booking) => (
                                        <tr key={booking.id} className="hover:bg-gray-50 transition">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-700">{booking.destination.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">{new Date(booking.visitDate).toLocaleDateString()}</td>
                                            <td className="px-6 py-4">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <h2 className="text-lg font-bold text-gray-900 mb-4">Core Actions</h2>
                            <div className="space-y-3">
                                <Link to="/admin/destinations" className="w-full flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    <span className="flex items-center gap-3 text-gray-700 group-hover:text-primary-600 font-medium">
                                        <Settings className="h-5 w-5 text-gray-400 group-hover:text-primary-500" /> Manage Limits
                                    </span>
                                </Link>
                                <Link to="/admin/rules" className="w-full flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    <span className="flex items-center gap-3 text-gray-700 group-hover:text-primary-600 font-medium">
                                        <Activity className="h-5 w-5 text-gray-400 group-hover:text-primary-500" /> Capacity Rules
                                    </span>
                                </Link>
                                <Link to="/admin/pricing" className="w-full flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    <span className="flex items-center gap-3 text-gray-700 group-hover:text-primary-600 font-medium">
                                        <DollarSign className="h-5 w-5 text-gray-400 group-hover:text-primary-500" /> Dynamic Pricing
                                    </span>
                                </Link>
                                <Link to="/admin/environmental" className="w-full flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    <span className="flex items-center gap-3 text-gray-700 group-hover:text-primary-600 font-medium">
                                        <Leaf className="h-5 w-5 text-gray-400 group-hover:text-primary-500" /> Environmental Impact
                                    </span>
                                </Link>
                                <Link to="/checkpost" className="w-full flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
                                    <span className="flex items-center gap-3 text-gray-700 group-hover:text-primary-600 font-medium">
